...
export async function generateMetadata({
  ...
  const url = `https://comtechsol.vercel.app/${slug}`;

  if (webPages) {
    return {
      title: `${webPages.pageTitle || webPages.pageName} | Comtechsol`,
      description:
  ...
  return {
    title: `${product.pageTitle || product.name} | Comtechsol`,
    description:
      product.metaDescription?.substring(0, 160) ||
      product.description?.substring(0, 160) ||
      "Buy quality servers, networking equipment, and IT solutions at Comtechsol.",
    keywords:
      product.searchKeywords ||
      `${product.name}, ${product.brand?.name}, Comtechsol`,
    alternates: {
      canonical: url,
    },
    openGraph: {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-12">
                ...
                >
                  ...
                  className="!text-[#2163c7] text-[11px]"
                  itemProp="name"
                >
                    {webPages?.pageName}
                  </span></h2>

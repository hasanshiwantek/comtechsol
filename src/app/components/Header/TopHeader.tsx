                      ...
                      >
                        <div className="flex">
                          ...
                          <div className="flex-1 p-4 flex flex-col">
                            ...
                            }} className="text-[1rem] text-[#545454] uppercase hover:text-[#3479e0]">
                            ...
                            <p onMouseDown={(e) => {
                              ...
                              const url = item?.productUrl || `/${item?.sku}`;
                              handleSelect(url);
                            }} className="text-[1rem] text-[#545454] mt-0.5 hover:text-[#3479e0]">
                              Sku: {item?.sku || "N/A"}
                            </p>
                            ...
                            <p onMouseDown={(e) => {
                              ...
                              const url = item?.productUrl || `/${item?.sku}`;
                              handleSelect(url);
                            }} className="text-[14px] font-bold text-[#54545F] leading-tight mt-2 line-clamp-2 min-h-[42px] hover:text-[#3479e0]">
                              {item?.name}
                            </p>
            ...
            <div className="flex items-center md:justify-end justify-between whitespace-nowrap flex-1 gap-5 md:gap-5">
              ...
              <div className="relative sm:flex hidden" ref={dropdownRef}>
                <div className="relative w-[40px]">
                  <div className="absolute z-[9999] -top-6 -bottom-7 right-0 left-0 bg-[#3479e0] hover:bg-[#3479e0] border-0 border-b-[3px] border-b-[#3479e0] transition cursor-pointer flex items-center justify-center"
                    onClick={() => setIsOpen((prev) => !prev)}
                  >
                    <FaShoppingCart className="w-7 h-7 text-white" />
                    <span className="absolute top-2 -right-3 bg-[#ffffff] text-[#3479e0] text-[10px] rounded-full w-6 h-6 flex items-center justify-center font-bold">
                      {cartItemCount || "0"}
                    </span>
                  </div>
                      ...
                      {cart.length === 0 ? (
                        ...
                        <div className="relative">
                            ...
                            {Object.values(
                              ...
                              <Link key={item?.id} href={item?.productUrl} onClick={() => setIsOpen(false)} className=" px-2 flex gap-3 items-center cursor-pointer border-b border-gray-300 pb-1 last:border-b-0">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <p className="text-[13px] font-light text-[#3479e0] leading-snug whitespace-pre-line break-words">
                                    {item?.name}
                                  </p>
                          ...
                          <div className="flex gap-2 p-4 pt-6">
                            <button
                              className="flex-1 font-[var(--font-roboto-condensed)] font-bold bg-[#3479e0] hover:bg-[#b81818] text-white text-[1rem] py-2.5 px-4 border-0 border-b-[3px] border-b-[#3479e0] transition uppercase tracking-wide"
              ...
              <div className="relative top-[3px] z-[999] sm:hidden flex" >
                <Link href="/cart" className="transition block">
                  <div className="bg-[#3479e0] p-2 rounded hover:bg-[#3479e0] transition">
                    <FaShoppingCart className="w-7 h-7 text-white" />
                    <span className="absolute top-2 -right-2 bg-white text-[#3479e0] text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
                      {cartItemCount || "0"}
                    </span>
                  </div>
                </Link>

      ...
      <nav className="w-full">
        <div className="flex items-center md:justify-between justify-center gap-4 h-20 sm:h-20 lg:h-24 w-full xl:max-w-[1170px] 2xl:max-w-[1170px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-1  2xl:px-2">
          ...
          <div className="flex lg:hidden items-center gap-3">
            ...
            {/* <Link
              href="/cart"
              className="relative text-gray-800 hover:text-[#2163c7] transition"
            >
              <button aria-label="cart" className="relative">
                <ShoppingCart className="w-6 h-6" />
                {cart?.length > 0 && (
                  <span className="absolute -top-2 -right-2 bg-[#3479e0] text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">
                    {cart?.length}
                  </span>
                )}
              </button>
            ...
            <div className="flex items-center gap-3 py-3 border-t">
              ...
              <div className="flex flex-col text-gray-800">
                <p className="text-sm font-medium">
                  Call:{" "}
                  <span className="text-[#2163c7] font-semibold">
                    +1 502-206-3033
                  </span>
                </p>
                <p className="text-sm">

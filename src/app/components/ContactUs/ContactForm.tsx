    ...
    <div className="w-[80%]  max-w-full lg:max-w-[1170px]  mx-0 lg:mx-auto  lg:px-[0%] px-[7%] ">
      ...
      <nav className="mb-6">
        <div className="flex items-center gap-2 text-sm">
          <Link href="/" className="text-[#3479e0] hover:underline">
            Home
          </Link>
          <span className="text-gray-600">/</span>
          <span className="text-[#3479e0]">Contact Form</span>
        </div>
      </nav>
      ...
      <div className="mb-8">
        ...
        <h2 className="sm:text-[28px] h1-lg ">Comtechsol, LLC</h2>
      </div>

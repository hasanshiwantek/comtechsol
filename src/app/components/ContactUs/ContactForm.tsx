    ...
    <div className="w-[80%]  max-w-full lg:max-w-[1170px]  mx-0 lg:mx-auto  lg:px-[0%] px-[7%] ">
      ...
      <div className="mb-8">
        ...
        <p className="text-[10px] text-[#545454] font-normal leading-[1.8]">
          By providing my phone number to Comtechsol LLC, I agree and acknowledge
          that Comtechsol may send text messages to my wireless phone number
          ...
          <a
            href="/privacy-Policy"
            className="text-[#3479e0] underline cursor-pointer"
            target="_blank"

        ...
        <div className="text-sm text-gray-700 space-y-2 mb-2">
          ...
          {showShipping && (
            ...
            >
              ...
              <div className="flex justify-end">
                ...
                // className="w-full md:w-[65%] p-2 border-b border-black  bg-[#3479e0] text-white text-[14px] font-bold"
                >
          ...
          {appliedCoupon && (
            <div className="flex gap-3 items-center rounded">
              ...
              <button
                ...
                className=" text-[14px] underline text-[#2163c7] hover:text-red-700"
              >
                Remove
              </button>
            </div>
          ...
          {showCoupon && !appliedCoupon && (
            ...
            >
              ...
              <button
                type="submit"
                className="border-b border-black px-12 rounded bg-[#3479e0] text-white text-[14px] font-bold disabled:opacity-50"
                disabled={couponLoading}
              >
                {couponLoading ? "..." : "Apply"}
              </button>

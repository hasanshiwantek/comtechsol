        ...
        <div className="p-4 md:p-6">
          ...
          {error && !loading && !isSubmit && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
              <p className="text-[#2163c7] text-lg font-medium mb-2">
                Error Loading Order
              </p>
              <p className="text-gray-700 mb-4">{error}</p>
              <button
                onClick={onClose}
                className="px-6 py-2 bg-[#3479e0] text-white rounded hover:bg-red-700 transition"
              >
                Close
              </button>
            </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      <label className="block font-medium text-lg md:text-xl mb-2">
                        Return Reason <span className="text-[#2163c7]">*</span>
                      </label>
                      <select
                        required
                        value={returnReason}

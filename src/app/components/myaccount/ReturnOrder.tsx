    ...
    return (
      <div className="p-4">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          <p className="text-[#2163c7] text-lg font-medium">{error}</p>
          <button
            onClick={() => window.location.reload()}
            className="mt-4 px-6 py-2 bg-[#3479e0] text-white rounded hover:bg-red-700 transition"
          >
            Retry
          </button>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center gap-4 md:w-[65%] w-full">
            ...
            <div className="flex flex-col items-center md:items-start justify-center w-full">
              {/* <Link href={`/my-account/orders/${order?.orderNumber || ""}`}> */}
                <p className="mb-1 text-xl text-[#2163c7] hover:text-red-700 transition-colors duration-200">

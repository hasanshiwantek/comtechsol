...
const MyAddress = () => {
  ...
  <div className="flex flex-col md:flex-row gap-4 mt-10">
    <Button
      ...
      className="w-full md:w-[16%] !p-7 text-2xl border-b-2 border-black bg-[#3479e0] text-white font-bold"
    >
      SAVE ADDRESS
    </Button>
    <Button
      onClick={() => setShowModal(false)}
      className="w-full md:w-36 !p-7 text-2xl border-b-2 border-black bg-[#3479e0] font-bold text-white transition"
    >
      CANCEL
    </Button>
  </div>
...
<button
  ...
  className="w-50 px-4 py-3 rounded text-2xl font-bold bg-[#3479e0] text-white border-b-2 border-black transition"
>
  Edit
</button>
...
>
  Delete
          ...
          <div className="border border-gray-400 rounded-lg p-6 flex flex-col items-center justify-center h-[206px] hover:bg-gray-50 cursor-pointer">
            ...
            >
              <Plus size={44} className="text-[#3479e0]" />
